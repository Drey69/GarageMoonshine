...
/*	  if (uart_available())
	  {
		  unsigned char a = (char)uart_read();
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, BMP_CS_Pin|out2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Ds18b20_Pin|beeper_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin : ledo_Pin */
  GPIO_InitStruct.Pin = ledo_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ledo_GPIO_Port, &GPIO_InitStruct);
