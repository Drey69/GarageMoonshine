...
#define EncoderButton_Pin GPIO_PIN_13
#define EncoderButton_GPIO_Port GPIOB
#define beeper_Pin GPIO_PIN_15
#define beeper_GPIO_Port GPIOB
#define EncoderCh1_Pin GPIO_PIN_6
#define EncoderCh1_GPIO_Port GPIOB
#define EncoderCh2_Pin GPIO_PIN_7
#define EncoderCh2_GPIO_Port GPIOB
